...
export const PROJECTING_PAGE_FETCH = 'PROJECTING_PAGE_FETCH';
export const INSERTION_PAGE_FETCH = 'INSERTION_PAGE_FETCH';
export const SERVICE_PAGE_FETCH = 'SERVICE_PAGE_FETCH';
export const MODERNIZATION_PAGE_FETCH = 'MODERNIZATION_PAGE_FETCH';
