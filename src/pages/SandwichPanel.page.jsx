            ...
            <Box display='flex' mt={'5rem'}>
                <Grid lg={4}>
                    <Box pl={'3rem'}>
                        <ul className={classes.optionlist}>
                            <li className={`active`}>О сэндвич-панелях</li>
                            <li>Приминение</li>
                            <li>Преимущества</li>
                            <li>Небольшой вес панелей</li>
                            <li>Теплоизоляция</li>
                            <li>Roof-lock</li>
                            <li>Secret fix</li>
                            <li>Cam lock</li>
                ...
                <Grid lg={8} className={classes.textlist}>
                    <Box display='flex' alignItems='center' justifyContent='center'>
                        <Box>
                            <p>Сэндвич представляет конструкцию, заключенную между двух профилированных листов из
                                металла, покрашенных в нужный цвет, в середине - теплоизоляционный слой из
                                пенополиуретана. Сэндчич-панели делятся на стеновые и кровельные. Небольшой срок
                                изготовления и простая технология монтажа позволяет активно использовать панели для
                                возведения быстровозводимых холодильных камер, ангаров, складов. Сэндвич панели
                                практически не имеют ограничений по использованию в различных типах зданий. Кроме того,
                                их используют при ремонте и для утепления зданий. Отличные эксплуатационные
                                характеристики создаются благодаря применению на производстве современной
                                технологии.</p>
                        </Box>
                    </Box>
                </Grid>
